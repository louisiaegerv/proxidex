...
export const metadata: Metadata = {
  metadataBase: new URL("https://app.proxidex.com"),
  title: "Proxidex - Free Pokémon Card Proxy Generator",
  description:
    "Search, browse, and create free proxies of any Pokémon card. 20,000+ cards available. Perfect for playtesting and casual games.",
  keywords: [
    "pokemon proxy",
    "pokemon tcg",
    "card proxy",
  ...
  return (
    <ClerkProvider>
      <html lang="en" suppressHydrationWarning>
        <body
          className={`${geistSans.variable} ${geistMono.variable} ${cinzelDecorative.variable} font-sans antialiased`}
        >
