...
// mm to pixels at 300 DPI (print resolution)
...
export function CardWithBleed({
  ...
  const [generatedBleedUrl, setGeneratedBleedUrl] = useState<string | undefined>(
    bleedImageUrl
  );
  ...
  useEffect(() => {
    ...
    draw();
  }, [imageUrl, generatedBleedUrl, bleedMm, canvasWidthPx, canvasHeightPx, bleedPx, showTrimLines, name]);
